...
I worked on a researh project on a small team tasked with controlling a robotic arm to pick out CubeSATs from space. Space trash is a large issues, and a lot of that are CubeSats. 

CubeSats are very small satellites (literally cube shaped) that are generally 10cm x 10cm x 10cm. You can have a multi-unit CubeSat, which is just multiple stacked ontop of one another. Generally they hitch rides with NASA or other space crafts. Since they're so small, they are relatively cheap to make, so most are made by amatures and students. These missions, however, are usually a one-way ticket. This project aimed at returning these to Earth. 
...
<img width="596" height="523" alt="image" src="https://github.com/user-attachments/assets/af9ed5df-7655-48c3-8b28-5e825af76a40" />
